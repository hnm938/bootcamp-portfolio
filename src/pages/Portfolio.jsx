      ...
      <div className="page-body">
        <div id="project-grid">
          <Project
            ...
            description={
              <p>
                ...
                collaborative efforts within a group, and the result was nothing
                short of outstanding.
                <br />
                <br />
                At its core, the concept is elegantly simple: an app designed to
                be your go-to source for all things cocktails and drinks. It's
                your bartender's encyclopedia, offering step-by-step recipes,
                ingredient lists, and fascinating tidbits about your favorite
                libations. The Cocktail Cabinet takes it a step further by also
                providing information on nearby bars, just in case you're up for
                some exploration.
                <br />
                ...
                ride-hailing integration, real-time availability checks at bars,
                and even intelligent dish recommendations to complement your
                drink choice based on ingredients. With these enhancements, it
                could transform into an indispensable, user-friendly app that
          ...
          <Project
            ...
            description={
              <p>
                ...
                teamwork dynamics, and it was all about setting ambitious goals.
                Our objective was clear: develop a fully functional social media
                app in just two weeks. As you can imagine, this was an ambitious
                undertaking.
                <br />
                <br />
                Despite the inevitable challenges that came with such a tight
                timeline, I believe we rose to the occasion. This project served
                as a valuable lesson for our team, highlighting the importance
                of realistic goal-setting and thorough planning, particularly
                during the whiteboarding phase of app development.
                <br />
                <br />
          ...
          <Project
            ...
            description={
              <p>
                Creating a text editor, while seemingly straightforward, becomes
                more intricate when transforming it into a progressive web app
                (PWA). My initial foray into developing a PWA text editor was
                educational, though it required some dedicated hours to grasp
                the concepts.
                <br />
                <br />
                Developing a PWA involves unique considerations, such as service
                workers, responsive design, and offline capabilities.
                Understanding these intricacies demanded patience, research, and
                troubleshooting. Over time, I gained a deeper understanding of
                PWAs and their potential benefits.
                <br />
                <br />
                Reflecting on this experience, I appreciate the initial learning
                curve, which paved the way for a more efficient development
                process. By leveraging the capabilities of PWAs, I improved the
                text editor's performance and accessibility.
                <br />
                <br />
                Looking back, I see this project as a valuable opportunity for
                skill growth and exploration of modern web technologies. It
                reinforced my commitment to staying current in the field of web
                development and adapting to emerging trends.
              </p>
            }
            links={
              <div className="project--links-buttons">
          ...
          <Project
            ...
            description={
              <p>
                ...
                particularly in the aspect of crafting the user interface (UI).
                <br />
                <br />
                ...
                <br />
                <br />
                While it may not be the most complex project in my portfolio, it
                serves as a reminder that even seemingly straightforward tasks
                can hold hidden gems of learning and enjoyment.
              </p>
            }
            links={
              <div className="project--links-buttons">
